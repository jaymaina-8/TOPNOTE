...
export function FeaturedProducts({ products }: FeaturedProductsProps) {
  return (
    <Section className="bg-neutral-50 py-14 md:py-16 lg:py-20">
      <Container>
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-2xl font-bold tracking-tight text-neutral-900 md:text-3xl">Featured products</h2>
          <p className="mt-2 text-sm leading-relaxed text-neutral-500 md:text-[0.9375rem]">
            Popular picks — available now. Message us on WhatsApp to check stock and order instantly.
          </p>
        </div>

        {products.length === 0 ? (
          <div className="mx-auto mt-10 max-w-lg rounded-xl bg-white p-8 text-center shadow-[var(--shadow-sm)]">
